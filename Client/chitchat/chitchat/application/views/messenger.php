...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../chitchat/assets/js/ckeditor/skins/moono-lisa/editor.css?t=HBDD">
...
<body class="sidebar-active">
    <div class="chitchat-loader">
        <div><img src="../chitchat/assets/images/logo/logo_big.png" alt="" />
    ...
    <div class="chitchat-container sidebar-toggle">
        <nav class="main-nav on custom-scroll">
            <div class="logo-warpper"><a href="messenger.html"><img src="../chitchat/assets/images/logo/logo.png" alt="logo" /></a></div>
            <div class="sidebar-main">
                ...
                <li><a class="button-effect" href="status" data-tippy-content="status" data-intro="Check Status here">
                            <div class="user-popup status one">
                                <div> <img class="bg-img" src="../chitchat/assets/images/avtar/2.jpg" alt="Avatar" /></div>
                            </div>
                        </a></li>
                    ...
                    <div class="recent-slider recent-chat owl-carousel owl-theme">
                        <div class="item">
                            <div class="recent-box">
                                ...
                                <div class="recent-profile"><img class="bg-img" src="../chitchat/assets/images/avtar/1.jpg" alt="Avatar" />
                                    <h6> John deo</h6>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="recent-box">
                                ...
                                <div class="recent-profile online"><img class="bg-img" src="../chitchat/assets/images/avtar/big/audiocall.jpg" alt="Avatar" />
                                    <h6> John </h6>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="recent-box">
                                ...
                                <div class="recent-profile"><img class="bg-img" src="../chitchat/assets/images/avtar/2.jpg" alt="Avatar" />
                                    <h6> Jpny</h6>
                                </div>
                            </div>
                        </div>
                ...
                <div class="chat custom-scroll">
                    <ul class="chat-cont-setting">
                        ...
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><span>new Contact</span>
                                <div class="icon-btn btn-outline-danger button-effect btn-sm"><i data-feather="users"></i></div>
                            </a></li>
                    </ul>
                    <div class="theme-title">
                        <div class="media">
...
-->
                                    ...
                                    <div class="tab-content" id="myTabContent1">
                                        <div class="tab-pane fade show active" id="direct" role="tabpanel" aria-labelledby="direct-tab">
                                            <ul class="chat-main">
                                                <li data-to="blank">
                                                    <div class="chat-box">
                                                        <div class="profile offline"><img class="bg-img" src="../chitchat/assets/images/contact/1.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                                ...
                                                <li class="active" data-to="chating">
                                                    <div class="chat-box">
                                                        <div class="profile online"><img class="bg-img" src="../chitchat/assets/images/contact/2.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Jony Lynetin</h5>
                                                            <h6>Typing................</h6>
                                                        </div>
                                                ...
                                                <li data-to="blank">
                                                    <div class="chat-box">
                                                        <div class="profile unreachable"><img class="bg-img" src="../chitchat/assets/images/contact/3.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Sufiya Elija</h5>
                                                ...
                                                <li data-to="blank">
                                                    <div class="chat-box">
                                                        <div class="profile busy"><img class="bg-img" src="../chitchat/assets/images/contact/4.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                                ...
                                                <li data-to="blank">
                                                    <div class="chat-box">
                                                        <div class="profile busy"><img class="bg-img" src="../chitchat/assets/images/contact/2.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Jhon Deo</h5>
                                                            <h6>Hi, i am josephin. How are you.. ! There are many variations of passages.</h6>
                                                        </div>
                                                ...
                                                <li data-to="blank">
                                                    <div class="chat-box">
                                                        <div class="profile busy"><img class="bg-img" src="../chitchat/assets/images/contact/1.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                        ...
                                        <div class="tab-pane fade" id="group" role="tabpanel" aria-labelledby="group-tab">
                                            ...
                                            <ul class="group-main">
                                                <li class="active" data-to="group_chat">
                                                    <div class="group-box">
                                                        <div class="profile"><img class="bg-img" src="../chitchat/assets/images/avtar/teq.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Tech Ninjas</h5>
                                                        ...
                                                        <div class="date-status">
                                                            <ul class="grop-icon">
                                                                <li><a class="group-tp" href="#" data-tippy-content="Josephin"> <img src="../chitchat/assets/images/contact/1.jpg" alt="group-icon-img" /></a></li>
                                                                <li><a class="group-tp" href="#" data-tippy-content="Jony "> <img src="../chitchat/assets/images/contact/2.jpg" alt="group-icon-img" /></a></li>
                                                                <li><a class="group-tp" href="#" data-tippy-content="Pabelo"> <img src="../chitchat/assets/images/contact/3.jpg" alt="group-icon-img" /></a></li>
                                                                <li>+ 35</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                ...
                                                <li data-to="group_blank">
                                                    <div class="group-box">
                                                        <div class="profile"><img class="bg-img" src="../chitchat/assets/images/avtar/family.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Family Ties</h5>
                                                            <h6>Lorem Ipsum is simply dummy text the printing and typesetting industry.</h6>
                                                        </div>
                                                ...
                                                <li data-to="group_blank">
                                                    <div class="group-box">
                                                        <div class="profile"><img class="bg-img" src="../chitchat/assets/images/avtar/girls.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                    ...
                                    <div class="tab-content" id="contactTabContent">
                                        <div class="tab-pane fade show active" id="con1" role="tabpanel" aria-labelledby="con1-tab">
                                            <ul class="call-log-main">
                                                <li class="active">
                                                    <div class="call-box">
                                                        <div class="profile offline"><img class="bg-img" src="../chitchat/assets/images/contact/2.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Jony Lynetin</h5>
                                                ...
                                                <li>
                                                    <div class="call-box">
                                                        <div class="profile online"><img class="bg-img" src="../chitchat/assets/images/contact/1.jpg" alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Jony Lynetin</h5>
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                <ul class="contact-log-main">
                                    ...
                                    <li>
                                        <div class="contact-box">
                                            <div class="profile busy"><img class="bg-img" src="../chitchat/assets/images/contact/3.jpg" alt="Avatar" /></div>
                                            <div class="details">
                                                <h5>Jony Lynetin</h5>
                                                <h6>+58 2564 02554</h6>
                                            </div>
                                    ...
                                    <li>
                                        <div class="contact-box">
                                            <div class="profile unreachable"><img class="bg-img" src="../chitchat/assets/images/contact/4.jpg" alt="Avatar" /></div>
                                            <div class="details">
                                                <h5>Jony Lynetin</h5>
                                                <h6>+44 55124 2524</h6>
                                            </div>
                                    ...
                                    <li>
                                        <div class="contact-box">
                                            <div class="profile online"><img class="bg-img" src="../chitchat/assets/images/contact/4.jpg" alt="Avatar" /></div>
                                            <div class="details">
                                                <h5>Jony Lynetin</h5>
                                                <h6>+54 541447 255 </h6>
                                            </div>
                    ...
                    <li>
                        <div class="chat-box">
                            <div class="media">
                                ...
                                <div class="media-body"><a class="icon-btn btn-outline-light btn-sm pull-right" href="../chitchat/assets/doc/messenger.html" target="_blank"><i data-feather="download"></i></a></div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="chat-box">
                            <div class="media">
                                ...
                                <div class="media-body"><a class="icon-btn btn-outline-light btn-sm pull-right" href="../chitchat/assets/doc/chapter1.MP4" target="_blank"> <i data-feather="download"></i></a></div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="chat-box">
                            <div class="media">
                                ...
                                <div class="media-body"><a class="icon-btn btn-outline-light btn-sm pull-right" href="../chitchat/assets/doc/salary.xlsx" target="_blank"> <i data-feather="download"></i></a></div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="chat-box">
                            <div class="media">
                                ...
                                <div class="media-body"><a class="icon-btn btn-outline-light btn-sm pull-right" href="../chitchat/assets/doc/document.pdf" target="_blank"> <i data-feather="download"></i></a></div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="chat-box">
                            <div class="media">
                                ...
                                <div class="media-body"><a class="icon-btn btn-outline-light btn-sm pull-right" href="../chitchat/assets/doc/details.txt" target="_blank"> <i data-feather="download"></i></a></div>
                            </div>
                        </div>
                    </li>
                    <li>
            ...
            <div class="settings-tab dynemic-sidebar custom-scroll" id="settings">
                <div class="theme-title">
                    ...
                    <div class="profile-box">
                        <div class="media">
                            <div class="profile"><img class="bg-img" src="../chitchat/assets/images/contact/2.jpg" alt="Avatar" /></div>
                            <div class="details">
                                <h5>Josephin water</h5>
                                <h6>Alabma , USA</h6>
                            </div>
                    ...
                    <div class="block">
                        ...
                        <ul class="help">
                            ...
                            <li>
                                ...
                                <ul class="wallpaper">
                                    <li><img class="bg-img" src="../chitchat/assets/images/wallpaper/2.jpg" alt="Avatar" /></li>
                                    <li><img class="bg-img" src="../chitchat/assets/images/wallpaper/1.jpg" alt="Avatar" /></li>
                                    <li><img class="bg-img" src="../chitchat/assets/images/wallpaper/3.jpg" alt="Avatar" /></li>
                                    <li><img class="bg-img" src="../chitchat/assets/images/wallpaper/4.jpg" alt="Avatar" /></li>
                                    <li><img class="bg-img" src="../chitchat/assets/images/wallpaper/5.jpg" alt="Avatar" /></li>
                                    <li><img class="bg-img" src="../chitchat/assets/images/wallpaper/6.jpg" alt="Avatar" /></li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <ul class="integratin">
                            <li>
                                <div class="media">
                                    ...
                                    <div class="media-right">
                                        <div class="profile"><img class="bg-img" src="../chitchat/assets/images/contact/1.jpg" alt="Avatar" /></div>
                                    </div>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <div class="media">
                                    ...
                                    <div class="media-right">
                                        <div class="profile"><img class="bg-img" src="../chitchat/assets/images/contact/3.jpg" alt="Avatar" /></div>
                                    </div>
                                </div>
                            </li>
                            <li>
            ...
            <div class="status-tab custom-scroll dynemic-sidebar" id="status">
                    ...
                    <div class="status-content">
                        <div class="media">
                            <div class="img-status">
                                <div class="user-status two"><img class="img-fluid bg-img" src="../chitchat/assets/images/avtar/girls.jpg" alt="status" /></div>
                ...
                <div class="contact-status-box">
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox"><img class="img-fluid bg-img" src="../chitchat/assets/images/status-img/small/sm-1.jpg" alt="status" /></a>
                                <div class="lightbox-target" id="statusbox"><img src="../chitchat/assets/images/status-img/large/lg-1.jpg" alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Josephin water</h5>
                                <p>today , 8:30am</p>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox2"><img class="img-fluid bg-img" src="../chitchat/assets/images/status-img/small/sm-2.jpg" alt="status" /></a>
                                <div class="lightbox-target" id="statusbox2"><img src="../chitchat/assets/images/status-img/large/lg-2.jpg" alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Jony Lynetin</h5>
                                <p>today , 10:30am</p>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox3"><img class="img-fluid bg-img" src="../chitchat/assets/images/status-img/small/sm-3.jpg" alt="status" /></a>
                                <div class="lightbox-target" id="statusbox3"><img src="../chitchat/assets/images/status-img/large/lg-3.jpg" alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Sufiya Elija</h5>
                                <p>today , 11:00am</p>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox4"><img class="img-fluid bg-img" src="../chitchat/assets/images/status-img/small/sm-4.jpg" alt="status" /></a>
                                <div class="lightbox-target" id="statusbox4"><img src="../chitchat/assets/images/status-img/large/lg-4.jpg" alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Mukrani Pabelo </h5>
                                <p>today , 9:55am</p>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox5"><img class="img-fluid bg-img" src="../chitchat/assets/images/status-img/small/sm-5.jpg" alt="status" /></a>
                                <div class="lightbox-target" id="statusbox5"><img src="../chitchat/assets/images/status-img/large/lg-5.jpg" alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Pabelo Mukrani</h5>
                                <p>today , 12:05am</p>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox6"><img class="img-fluid bg-img" src="../chitchat/assets/images/status-img/small/sm-3.jpg" alt="status" /></a>
                                <div class="lightbox-target" id="statusbox6"><img src="../chitchat/assets/images/status-img/large/lg-3.jpg" alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Sufiya Elija</h5>
                                <p>today , 11:00am</p>
        ...
        <div class="chitchat-main small-sidebar" id="content">
            <div class="chat-content tabto active">
                <div class="messages custom-scroll active" id="chating">
                            ...
                            <div class="col-7">
                                <div class="media left">
                                    <div class="media-left me-3">
                                        <div class="profile online menu-trigger"><img class="bg-img" src="../chitchat/assets/images/contact/2.jpg" alt="Avatar" /></div>
                                    </div>
                                    <div class="media-body">
                                        <h5>Josephin water</h5>
                    ...
                    <div class="contact-chat">
                        <ul class="chatappend">
                            <li class="replies">
                                <div class="media">
                                    <div class="profile me-4"><img class="bg-img" src="../chitchat/assets/images/contact/2.jpg" alt="Avatar" /></div>
                                    <div class="media-body">
                            ...
                            <li class="replies">
                                <div class="media">
                                    <div class="profile me-4"><img class="bg-img" src="../chitchat/assets/images/avtar/1.jpg" alt="Avatar" /></div>
                                    <div class="media-body">
                                        <div class="contact-name">
                                            <h5>Alan josheph</h5>
                                            <h6>01:40 AM</h6>
                                            <ul class="msg-box">
                                                ...
                                                <li class="msg-setting-main">
                                                    <div class="document"><i class="fa fa-file-excel-o font-primary"></i>
                                                        ...
                                                        <div class="icon-btns"><a class="icon-btn btn-outline-light" href="../chitchat/assets/doc/Document.xlsx" target="_blank"><i data-feather="download"> </i></a></div>
                                                    </div>
                                            ...
                                            <ul class="msg-box">
                                                ...
                                                <li class="msg-setting-main">
                                                    <ul class="auto-gallery">
                                                        <li><img class="bg-img" src="../chitchat/assets/images/media/1.jpg" alt="Avatar" /></li>
                                                        <li> <img class="bg-img" src="../chitchat/assets/images/media/2.jpg" alt="Avatar" /></li>
                                                        <li> <img class="bg-img" src="../chitchat/assets/images/media/3.jpg" alt="Avatar" /></li>
                                                    </ul>
                ...
                <div class="messages custom-scroll" id="blank">
                    ...
                    <div class="call-list-center"><img src="../chitchat/assets/images/chat.png" alt="" />
                    ...
                    <div class="contact-details">
                        <div class="row">
                            <div class="col">
                                <div class="media left">
                                    <div class="media-left me-3">
                                        <div class="profile online menu-trigger"><img class="bg-img" src="../chitchat/assets/images/avtar/teq.jpg" alt="Avatar" /></div>
                                    </div>
                                    <div class="media-body">
                                        <h5>Tech Ninjas</h5>
                                        <div class="badge badge-success">Active</div>
                    ...
                    <div class="contact-chat">
                        <ul class="chatappend">
                            <li class="groupuser">
                                ...
                                <div class="gr-profile dot-btn dot-success grow"><img class="bg-img" src="../chitchat/assets/images/avtar/3.jpg" alt="Avatar" /></div>
                                <div class="gr-profile dot-btn dot-success grow"><img class="bg-img" src="../chitchat/assets/images/avtar/5.jpg" alt="Avatar" /></div>
                            </li>
                            <li class="sent">
                                <div class="media">
                                    <div class="profile me-4"><img class="bg-img" src="../chitchat/assets/images/contact/2.jpg" alt="Avatar" /></div>
                    ...
                    <div class="contact-details">
                        <div class="row">
                            <div class="col">
                                <div class="media left">
                                    <div class="media-left me-3">
                                        <div class="profile online menu-trigger"><img class="bg-img" src="../chitchat/assets/images/avtar/family.jpg" alt="Avatar" /></div>
                                    </div>
                                    <div class="media-body">
                                        <h5>Family Ties</h5>
                    ...
                    <div class="wrap emojis-main"><a class="icon-btn btn-outline-primary button-effect me-3 toggle-sticker outside" href="#">
                        ...
                        <div class="sticker-contain">
                            <div class="sticker-sub-contain custom-scroll">
                                <ul>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/1.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/2.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/3.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/3.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/4.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/5.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/6.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/7.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/8.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/9.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/10.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/11.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/12.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/13.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/14.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/15.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/16.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/17.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/18.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/19.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/20.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/21.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/22.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/23.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/24.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/25.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/26.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/27.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/28.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/29.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/30.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/31.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/32.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/33.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/34.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/35.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/36.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/37.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/38.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/39.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/40.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/41.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/42.gif" alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid" src="../chitchat/assets/images/sticker/43.gif" alt="sticker" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="user-profile mb-3">
                            <div class="user-content"><img class="img-fluid" src="../chitchat/assets/images/contact/2.jpg" alt="user-img" />
            ...
            <div class="contact-content tabto">
                <div class="contact-sub-content"><a class="icon-btn btn-outline-primary button-effect mobile-back mb-3" href="#"><i class="ti-angle-left"></i></a>
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="user-profile">
                                <div class="user-content"><img class="img-fluid bg-icon" src="../chitchat/assets/images/contact/2.jpg" alt="user-img" />
                                    <h3>Josephin water</h3>
                                    <ul>
                                        <li><i class="fa fa-twitch"> </i>massage</li>
                                    ...
                                    <ul class="integratin mt-0">
                                        <li>
                                            <div class="media">
                                                ...
                                                <div class="media-right">
                                                    <div class="profile bg-size"><img class="bg-img" src="../chitchat/assets/images/contact/1.jpg" alt="Avatar" /></div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="media">
                                                ...
                                                <div class="media-right">
                                                    <div class="profile bg-size"><img class="bg-img" src="../chitchat/assets/images/contact/3.jpg" alt="Avatar" /></div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="media">
                                                ...
                                                <div class="media-right">
                                                    <div class="profile bg-size"><img class="bg-img" src="../chitchat/assets/images/contact/2.jpg" alt="Avatar" /></div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
        ...
        <aside class="chitchat-right-sidebar" id="slide-menu">
            <div class="custom-scroll right-sidebar">
                <div class="contact-profile">
                    ...
                    <div class="details">
                        <div class="contact-top"><img class="bg-img" src="../chitchat/assets/images/avtar/2.jpg" alt="" /></div>
                        <div class="name">
                            <h3>Josephin water</h3>
                        ...
                        <div class="block-content">
                            <div class="row share-media zoom-gallery">
                                ...
                                <div class="col-4 isotopeSelector filter">
                                    <div class="media-big">
                                        <div class="overlay">
                                            <div class="border-portfolio"><a href="../chitchat/assets/images/gallery/1.jpg">
                                                    <div class="overlay-background"><i class="ti-plus" aria-hidden="true"></i></div><img class="img-fluid bg-img" src="../chitchat/assets/images/gallery/1.jpg" alt="portfolio-image" />
                                                </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="media-small isotopeSelector filter">
                                        <div class="overlay">
                                            <div class="border-portfolio"><a href="../chitchat/assets/images/gallery/2.jpg">
                                                    <div class="overlay-background"><i class="ti-plus" aria-hidden="true"></i></div><img class="img-fluid bg-img" src="../chitchat/assets/images/gallery/2.jpg" alt="portfolio-image" />
                                                </a></div>
                                        </div>
                                    </div>
                                    <div class="media-small isotopeSelector filter">
                                        <div class="overlay">
                                            <div class="border-portfolio"><a href="../chitchat/assets/images/gallery/3.jpg">
                                                    <div class="overlay-background"><i class="ti-plus" aria-hidden="true"></i></div><img class="img-fluid bg-img" src="../chitchat/assets/images/gallery/3.jpg" alt="portfolio-image" />
                                                </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="media-small isotopeSelector filter">
                                        <div class="overlay">
                                            <div class="border-portfolio"><a href="../chitchat/assets/images/gallery/4.jpg">
                                                    <div class="overlay-background"><i class="ti-plus" aria-hidden="true"></i></div><img class="img-fluid bg-img" src="../chitchat/assets/images/gallery/4.jpg" alt="portfolio-image" />
                                                </a></div>
                                        </div>
                                    </div>
                                    <div class="media-small isotopeSelector filter fashion">
                                        <div class="overlay">
                                            <div class="border-portfolio"><a href="../chitchat/assets/images/gallery/5.jpg">
                                                    <div class="overlay-background"><i class="ti-plus" aria-hidden="true"></i></div><img class="img-fluid bg-img" src="../chitchat/assets/images/gallery/5.jpg" alt="portfolio-image" />
                                                </a></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="block-content">
                            <div class="contact-chat p-0 m-0">
                                <ul class="str-msg">
                                    ...
                                    <li>
                                        <div class="media">
                                            <div class="profile me-4"><img class="bg-img" src="../chitchat/assets/images/contact/3.jpg" alt="Avatar" /></div>
                                            <div class="media-body">
                                                <div class="contact-name">
                                                    <h5>Josephin water</h5>
                                                    <h6>01:35 AM</h6>
            ...
            <div class="apps">
                <ul class="apps-ul">
                        ...
                        <div class="todo-main">
                            <div class="theme-title">
                                <div class="media">
                                    ...
                                    <div class="media-body media-body text-end"><a class="icon-btn btn-sm btn-outline-light close-apps" href="#"><i data-feather="x"></i></a></div>
                                </div>
                            </div>
                            <div class="todo-name">
                            ...
                            <div class="todo-tab theme-tab custom-scroll">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a class="nav-link button-effect active show" data-bs-toggle="pill" href="#todo1">All</a></li>
                                    <li class="nav-item"><a class="nav-link button-effect" data-bs-toggle="pill" href="#todo2">My to-dos</a></li>
                                    <li><a class="icon-btn btn-light button-effect btn-sm" data-bs-toggle="modal" data-bs-target="#todoModal"><i data-feather="plus"> </i></a></li>
                                </ul>
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="todo2">
                                        <div class="converstaion-docs tab-card"><i class="fa fa-sticky-note-o"></i>
                                            <h5 class="mb-3">No Open To-Dos Here </h5><a class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#createtodoModal">Create A To-Do</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <li id="files">
                        ...
                        <div class="theme-tab">
                            <ul class="nav nav-tabs">
                                <li class="nav-item"><a class="nav-link button-effect active" data-bs-toggle="pill" href="#tab1">Media</a></li>
                                <li class="nav-item"><a class="nav-link button-effect" data-bs-toggle="pill" href="#tab2">Link</a></li>
                                <li class="nav-item"><a class="nav-link button-effect" data-bs-toggle="pill" href="#tab3">Docs</a></li>
                            </ul>
                        </div>
                        <div class="file-tab">
                            <div class="tab-content custom-scroll">
                                ...
                                <div class="tab-pane fade" id="tab2">
                                    <div class="link-group">
                                        ...
                                        <div class="media"><img class="img-fluid" src="../chitchat/assets/images/file_icons/12.png" alt="media-img" />
                                            <div class="media-body">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="media"><img class="img-fluid" src="../chitchat/assets/images/file_icons/3.png" alt="media-img" />
                                            <div class="media-body">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="media"><img class="img-fluid" src="../chitchat/assets/images/file_icons/8.png" alt="media-img" />
                                            <div class="media-body">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="media"><img class="img-fluid" src="../chitchat/assets/images/file_icons/9.png" alt="media-img" />
                                            <div class="media-body">
                                                <h5>HTML Template.</h5>
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="media"><img class="img-fluid" src="../chitchat/assets/images/file_icons/11.png" alt="media-img" />
                                            <div class="media-body">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="media"><img class="img-fluid" src="../chitchat/assets/images/file_icons/10.png" alt="media-img" />
                                            <div class="media-body">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="media"><img class="img-fluid" src="../chitchat/assets/images/file_icons/7.png" alt="media-img" />
                                            <div class="media-body">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="media"><img class="img-fluid" src="../chitchat/assets/images/file_icons/4.png" alt="media-img" />
                                            <div class="media-body">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="media"><img class="img-fluid" src="../chitchat/assets/images/file_icons/6.png" alt="media-img" />
                                            <div class="media-body">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="media"><img class="img-fluid" src="../chitchat/assets/images/file_icons/5.png" alt="media-img" />
                                            <div class="media-body">
                        ...
                        <div class="notes-main">
                            ...
                            <form class="default-form">
                                <div class="form-group notes-content">
                                    ...
                                    <ul>
                                        <li><a class="icon-btn btn-light button-effect btn-sm" data-bs-toggle="modal" data-bs-target="#notesModal"><i data-feather="plus"></i></a></li>
                                    </ul>
                                </div>
                            </form>
                            <div class="notes-list">
                                <h6 class="mb-2 text-muted">Joshephin Water.10 Jan</h6>
                                <div class="media"><img class="img-fluid me-3" src="../chitchat/assets/images/file_icons/5.png" alt="media-img" />
                                    <div class="media-body">
                    ...
                    <li id="reminder">
                        <div class="reminder-main">
                            ...
                            <div class="reminder-content tab-card"><i class="ti-alarm-clock"></i>
                                <p>Never forget important tasks. Set personal and group reminders.</p><a class="setreminder btn btn-primary button-effect btn-sm" data-bs-toggle="modal" data-bs-target="#setReminder">set reminder</a>
                            </div>
    ...
    <div class="modal fade" id="audiocall" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-body">
                <div class="audiocall1 call-modal"><img class="bg-img" src="../chitchat/assets/images/avtar/big/audiocall.jpg" alt="Avatar" />
    ...
    <div class="viddiolog modal fade" id="videocall" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-body">
                <div class="videocall call-modal"><img class="bg-img" src="../chitchat/assets/images/avtar/big/videocall_bg.jpg" alt="Avatar" />
                    <div class="small-image"><img class="bg-img" src="../chitchat/assets/images/avtar/big/videocall.jpg" alt="Avatar" /></div>
                    <div class="media videocall-details">
                        <div class="usersprof">
                            <div class="profile"><img class="bg-img" src="../chitchat/assets/images/avtar/2.jpg" alt="Avatar" /></div>
                            <div class="profile"><img class="bg-img" src="../chitchat/assets/images/avtar/3.jpg" alt="Avatar" /></div>
                        </div>
                        <div class="media-body">
                            <h5>Josephin water</h5>
                        ...
                        <div class="zoomcontent"><a class="text-dark" href="#!" onclick="javascript:toggleFullScreen()" data-tippy-content="Zoom Screen"><img src="../chitchat/assets/images/logo/maximize.svg" alt="zoom screen" /></a></div>
                    </div>
                    <div class="center-con text-center">
                        <ul>
    ...
    <div class="modal fade" id="confercall" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-body">
                <div class="conferencecall call-modal"><img class="bg-img" src="../chitchat/assets/images/avtar/big/audiocall.jpg" alt="Avatar" />
                    <div class="center-con text-center">
                        <div class="usersprof">
                            <div class="profile"><img class="bg-img" src="../chitchat/assets/images/avtar/2.jpg" alt="Avatar" /></div>
                            <div class="profile"><img class="bg-img" src="../chitchat/assets/images/avtar/3.jpg" alt="Avatar" /></div>
                            <div class="profile"><img class="bg-img" src="../chitchat/assets/images/avtar/5.jpg" alt="Avatar" /></div>
                            <div class="profile"><img class="bg-img" src="../chitchat/assets/images/avtar/big/videocall_bg.jpg" alt="Avatar" /></div>
                        </div>
                        <p>Incoming Call</p>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row confimg">
                        <div class="col-6">
                            <div class="vclimg"><img class="bg-img" src="../chitchat/assets/images/avtar/big/videocall_bg.jpg" alt="Avatar" /></div>
                        </div>
                        <div class="col-6">
                            <div class="vclimg"><img class="bg-img" src="../chitchat/assets/images/avtar/5.jpg" alt="Avatar" /></div>
                        </div>
                        <div class="col-6">
                            <div class="vclimg"><img class="bg-img" src="../chitchat/assets/images/avtar/2.jpg" alt="Avatar" /></div>
                        </div>
                        <div class="col-6">
                            <div class="vclimg"><img class="bg-img" src="../chitchat/assets/images/avtar/3.jpg" alt="Avatar" /></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade audiorcvcall" id="audiorcvcall" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-body">
                <div class="audiocall2 call-modal"><img class="bg-img" src="../chitchat/assets/images/avtar/big/audiocall.jpg" alt="Avatar" />
                    <div class="center-con text-center">
    ...
    <script src="../chitchat/assets/js/jquery-3.3.1.min.js"></script>
    <script src="../chitchat/assets/js/owl.carousel.js"></script>
    <script src="../chitchat/assets/js/popper.min.js"></script>
    <script src="../chitchat/assets/js/tippy-bundle.iife.min.js"></script>
    <script src="../chitchat/assets/js/bootstrap.bundle.js"></script>
    <script src="../chitchat/assets/js/switchery.js"></script>
    <script src="../chitchat/assets/js/easytimer.min.js"> </script>
    <script src="../chitchat/assets/js/index.js"> </script>
    <script src="../chitchat/assets/js/feather-icon/feather.min.js"></script>
    <script src="../chitchat/assets/js/feather-icon/feather-icon.js"></script>
    <script src="../chitchat/assets/js/ckeditor/ckeditor.js"></script>
    <script src="../chitchat/assets/js/ckeditor/styles.js"></script>
    <script src="../chitchat/assets/js/ckeditor/adapters/jquery.js"></script>
    <script src="../chitchat/assets/js/ckeditor/ckeditor.custom.js"></script>
    <script src="../chitchat/assets/js/date-picker/datepicker.js"></script>
    <script src="../chitchat/assets/js/date-picker/datepicker.en.js"></script>
    <script src="../chitchat/assets/js/date-picker/datepicker.custom.js"></script>
    <script src="../chitchat/assets/js/tour/intro.js"></script>
    <script src="../chitchat/assets/js/tour/intro-init.js"></script>
    <script src="../chitchat/assets/js/jquery.magnific-popup.js"></script>
    <script src="../chitchat/assets/js/zoom-gallery.js"></script>
    <script src="../chitchat/assets/js/script.js"></script>
